...
test_that("regression / eval_index: SummaryCV$eval_1fold[1]", {
  expect_true(SummaryCV$eval_1fold[1] < 21000)
  # expect_equal(round(SummaryCV$eval_1fold[1], -3), 21000)
})
# assert(paste0("\n SummaryCV$eval_1fold[1] = ", SummaryCV$eval_1fold[1]),
#        SummaryCV$eval_1fold[1] > 20000 & SummaryCV$eval_1fold[1] < 21000)
#
#
## clean up
#
...
test_that("classification / eval_index: SummaryCV$eval_1fold[1]", {
  expect_true(SummaryCV$eval_1fold[1] > 0.77)
